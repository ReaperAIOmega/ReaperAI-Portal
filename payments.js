...
async function loadPayments({ supabase }) {
  ...
  const { data, error } = await supabase
    .from('payments')
    .select('id,description,amount,currency,status,due_date,paid_at,created_at')
  ...
  table.innerHTML = '<thead><tr><th>Description</th><th>Amount</th><th>Status</th><th>Due</th><th>Paid</th></tr></thead>';
